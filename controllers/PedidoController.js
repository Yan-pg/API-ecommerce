...
const PagementoValidation = require("./validacoes/pagamentoValidation")
    ...
    // CLIENTE 
        ...
        async store(req, res, next){
            ...
            try{
                ...
                if(! await pagamentoValidation(carrinho, entrega,pagamento)) return res.status(422).send({ error: "Dados de Pagamento Inválidos"})
                ...
                const novoPagamento = new Pagamento({
                    ...
                    enderecoEntregaIgualCobraca: pagamento.enderecoEntregaIgualCobraca,
                    loja
                })
